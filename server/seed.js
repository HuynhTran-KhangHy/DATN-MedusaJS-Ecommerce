...
const seedData = async () => {
  try {
    ...
    // Tạo sản phẩm mẫu
    const p1 = await Product.create({ name: 'iPhone 15 Pro Max', base_price: 30000000, description: 'Sản phẩm mới nhất từ Apple với khung titan siêu bền.', is_featured: true, categoryId: cat1.id, image: 'https://img.tgdd.vn/img-border/iphone-15-pro-max-blue-1-600x600.jpg' });
    const p2 = await Product.create({ name: 'Samsung Galaxy S24 Ultra', base_price: 28000000, description: 'Siêu phẩm AI từ Samsung hỗ trợ bút S Pen.', is_featured: true, categoryId: cat1.id, image: 'https://img.tgdd.vn/img-border/samsung-galaxy-s24-ultra-grey-600x600.jpg' });
    ...
    await Product.bulkCreate([
      { name: 'MacBook Air M3', base_price: 26000000, description: 'Laptop mỏng nhẹ hiệu năng cao với chip M3 mạnh mẽ.', is_featured: true, categoryId: cat2.id, image: 'https://img.tgdd.vn/img-border/macbook-air-m3-13-inch-8gb-256gb-silver-600x600.jpg' },
      { name: 'iPad Pro M2', base_price: 21000000, description: 'Máy tính bảng mạnh mẽ nhất với màn hình Liquid Retina XDR.', is_featured: true, categoryId: cat3.id, image: 'https://img.tgdd.vn/img-border/ipad-pro-m2-11-wifi-grey-600x600.jpg' },
      { name: 'AirPods Pro 2', base_price: 5500000, description: 'Tai nghe chống ồn đỉnh cao với chip H2.', is_featured: true, categoryId: cat4.id, image: 'https://img.tgdd.vn/img-border/airpods-pro-2-600x600.jpg' },
    ]);
