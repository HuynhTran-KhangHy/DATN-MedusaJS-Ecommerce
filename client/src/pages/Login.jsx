    ...
    <div className="auth-layout">
      ...
      <div className="auth-visual">
        ...
        <div className="auth-visual-content">
          ...
          <div className="flex-center" style={{ gap: '2rem', marginTop: '2rem', display: 'flex' }}>
            <div>
              <div style={{ fontFamily: '"Bebas Neue",sans-serif', fontSize: '1.8rem', color: 'white' }}>50K+</div>
              <div className="text-xs" style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.7rem' }}>Khách hàng</div>
            </div>
            <div>
              <div style={{ fontFamily: '"Bebas Neue",sans-serif', fontSize: '1.8rem', color: 'white' }}>1.2M+</div>
              <div className="text-xs" style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.7rem' }}>Đơn hàng</div>
            </div>
            <div>
              <div style={{ fontFamily: '"Bebas Neue",sans-serif', fontSize: '1.8rem', color: 'white' }}>99%</div>
              <div className="text-xs" style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.7rem' }}>Hài lòng</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="auth-form-side">
        <div className="auth-form-wrap">
          ...
          <p className="text-sm text-muted" style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem' }}>
            Chưa có tài khoản? <Link to="/register" className="form-link" style={{ color: 'var(--accent)', fontWeight: 600 }}>Đăng ký ngay</Link>
          </p>
        </div>
      </div>
    </div>
